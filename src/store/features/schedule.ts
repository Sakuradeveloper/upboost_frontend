...
export const fetchSchedules = createAsyncThunk('teacher/fetchSchedule', async (id: number|undefined) => {
    const res = await getRequest(`/v0/teacher/schedule/${id}`);
    return res; 
});

// export const fetchSchedule = createAsyncThunk('teacher/schedule', async (id: number) => {
//     const res = await getRequest(`/v0/teacher/schedules/${id}`);
//     return res;
// });
