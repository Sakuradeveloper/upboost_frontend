...
import { Box, Button, Card, CardContent, Modal, Typography, Fade, Backdrop } from "@mui/material";
...
import { setCurrentItemValue, clearCurrentItem, setError, fetchSchedules, setResult } from '@/store/features/schedule';
            ...
            <CardContent sx={{ p: { xs: 2, sm: 4 } }}>
              ...
              >
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  ...
                  <TimePicker
                    label="開始時間 *"
                    value={dayjs(`${current.date} ${current.start_time}`, 'YYYY-MM-DD HH:mm')}
                    onChange={(newValue) =>
                  ...
                  <TimePicker
                    label="終了時間 *"
                    value={dayjs(`${current.date} ${current.end_time}`, 'YYYY-MM-DD HH:mm')}
                    onChange={(newValue) =>
